...
const Dashboard = () => {
  ...
  const todaysBookings = useMemo(
    () =>
      bookings
        .filter((b) => b.date && isSameDay(new Date(b.date), today))
        .slice(0, 6),
    [bookings, today],
  );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold font-display">
            {greeting}, {appUser?.fullName?.split(" ")[0] || "Admin"} 👋
          </h1>
          ...
          <>
            ...
            >
              <StatCard
                ...
                change={(dashboardStats as any).membersChange ?? 0}
                icon={Users}
              />
            </button>
            <button
            ...
            >
              <StatCard
                ...
                value={formatNPR(dashboardStats.monthlyRevenue)}
                change={dashboardStats.revenueChange}
                icon={DollarSign}
                iconColor="gradient-gold"
              />
            </button>
            <button
            ...
            >
              <StatCard
                ...
                change={dashboardStats.checkinsChange}
                icon={UserCheck}
              />
            </button>
          </>
          ...
          {alertsLoading ? (
            ...
            <div className="space-y-3">
              {expiryAlerts.map((a) => (
                <div
                  key={a.memberId}
                  className="flex items-center gap-3 rounded-lg border border-warning/20 bg-warning/5 p-3 cursor-pointer"
                ...
                >
                  ...
                  <Badge
                    variant="outline"
                    className="text-warning border-warning/30 text-[10px] whitespace-nowrap"
                  >
                    {a.daysLeft}d left
                  </Badge>
                </div>
